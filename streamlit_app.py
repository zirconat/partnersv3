...
with st.container():
    ...
    st.markdown("""
        <div style="background-color: #FFF4E5; padding: 10px 2px 2px 20px; border-radius: 15px 15px 0 0; border-left: 8px solid #FF9800; border-top: 1px solid #FFE0B2; border-right: 1px solid #FFE0B2;">
